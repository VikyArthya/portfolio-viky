  ...
  return (
    <section id="contact" className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md"> I'm currently open to new freelance / part-time opportunities. Feel free to reach out if you have any questions or collaboration ideas — I'll do my best to respond promptly.</p>
